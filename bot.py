...
class MiBot(commands.Bot):
    ...
    async def load_all_cogs(self):
        ...
        for extension in extensions:
            ...
            try:
                ...
                # IMPORTANTE:
                # Un cog roto no debe impedir que
                # los demás comandos funcionen.
    ...
    async def show_loaded_commands(self):
        ...
        if len(slash_commands) > 100:
            ...
            print(
                "   Hay más de 100 slash commands."
            )

            print(
                "   Discord no permite más de "
                "100 comandos globales."
            )
    ...
    async def sync_guild_commands(self):
        ...
        # add_command(...)
        #
        # porque eso estaba mezclando árboles globales
        # y de servidor.
        #
        # Acá usamos copy_global_to(guild=...)
        # correctamente.
        #
        # ====================================================
        ...
        try:
            ...
            if commands_count > 100:
                ...
                print(
                    "⚠️ Los comandos prefix "
                    "seguirán funcionando."
                )

                print(
                    "⚠️ Hay que convertir algunos "
                    "comandos a prefix-only."
                )
