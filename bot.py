...
class MiBot(commands.Bot):
    ...
    async def load_all_cogs(self):
        ...
        for extension in extensions:
            ...
            try:
            ...
            except discord.app_commands.CommandLimitReached as error:
                ...
                print("")
                print(
                    f"⚠️ LÍMITE DE SLASH: {extension}"
                )

                print(
                    "   Este cog tiene demasiados "
                    "comandos slash."
                )
    ...
    async def sync_commands(self):
        ...
        print("")
        print(
            "ℹ️ Los comandos principales "
            "se están registrando en tu servidor."
        )

        print(
            "ℹ️ No se realiza sync global "
            "para evitar el límite de 100."
        )
