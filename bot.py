...
class MiBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        # ----------------------------------------------------
        # ELIMINAR POSIBLES DUPLICADOS DEL TREE
        # ----------------------------------------------------
    ...
    # ========================================================
    # ELIMINAR DUPLICADOS DEL COMMAND TREE
    # ========================================================
    ...
    def remove_duplicate_commands(self):
        ...
        print("")
        print("=" * 70)
        print("🧹 REVISANDO COMANDOS DUPLICADOS")
        print("=" * 70)
    ...
    async def sync_commands(self):
        ...
        try:
            ...
            # ----------------------------------------------
            # Añadir los comandos actuales al guild tree
            # ----------------------------------------------
