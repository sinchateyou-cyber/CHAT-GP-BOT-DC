...
class MiBot(commands.Bot):
    ...
    async def sync_commands(self):
        ...
        try:
            ...
            # IMPORTANTE:
            #
            # El árbol YA fue creado como guild-specific.
            # No usamos copy_global_to.
            # No usamos clear_commands.
            # No usamos sync global.
            # ------------------------------------------------
