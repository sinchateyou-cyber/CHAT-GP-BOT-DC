...
class MiBot(commands.Bot):
    ...
    async def load_persistent_views(self):
        ...
        # IMPORTANTE:
        #
        # NO registramos RoleView acá.
        #
        # reactionroles.py se encarga de registrar
        # sus propias views.
        #
        # Esto evita registrar dos veces los mismos
        # custom_id.
        # ====================================================

        print(
            "✅ Reaction Roles gestionado por "
            "cogs.reactionroles"
        )
...
async def test(
    ...
    print(
        f"🟢 /test recibido de {interaction.user}"
    )
...
def api_guilds():
    ...
    if not is_logged_in():
        ...
        return jsonify({
            "success": False,
            "message": "Debes iniciar sesión con Discord.",
            "guilds": []
        }), 401
