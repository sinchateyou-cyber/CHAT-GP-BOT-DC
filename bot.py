...
class MiBot(
    ...
    async def setup_hook(
        ...
        # ====================================================
        # REGISTRAR REACTION ROLES PERSISTENTES
        # ====================================================
...
async def on_ready():
    ...
    print(
        "🎭 Reaction Roles persistentes activados."
    )
...
async def on_command_error(
    ...
    if isinstance(
        ...
        await ctx.send(
            ...
            "❌ Faltan argumentos para ejecutar este comando.",
    ...
    if isinstance(
        ...
        await ctx.send(
            ...
            "❌ No cumplís los requisitos para usar este comando.",
...
async def main():
    ...
    try:
        ...
        print(
            "❌ ERROR: El token de Discord es inválido."
        )
