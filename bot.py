...
class LimitedCommandTree(app_commands.CommandTree):
    ...
    """
    CommandTree personalizado.

    Discord permite como máximo 100 comandos de aplicación
    globales por aplicación.

    Los comandos que superen ese límite NO se agregan al
    CommandTree global, pero el HybridCommand sigue existiendo
    como comando de prefijo.

    IMPORTANTE:
    discord.py no permite pasar simultáneamente:

        guild=...
        guilds=...

    Por eso normalizamos esos argumentos antes de llamar
    a CommandTree.add_command().
    """
    ...
    def add_command(
        ...
        *,
        ...
        # ----------------------------------------------------
        # CASO 1:
        # guild y guilds fueron enviados juntos
        # ----------------------------------------------------
        #
        # discord.py lanza:
        #
        # TypeError:
        # cannot mix guild and guilds keyword arguments
        #
        # Si ambos llegan, convertimos todo a una lista
        # de guilds.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # CASO 2:
        # comando específico de servidor
        # ----------------------------------------------------
        ...
        if command_name in existing_names:
            ...
            # No volver a agregar el mismo comando.
            return
        ...
        if len(current_commands) >= MAX_GLOBAL_SLASH_COMMANDS:
            ...
            if command_name not in self.skipped_commands:
                ...
                print(
                    "   ↳ El comando seguirá "
                    "funcionando con prefijo."
                )

            # NO agregarlo al árbol.
            #
            # El HybridCommand ya fue registrado como
            # comando de prefijo por discord.py.
            return

        # ----------------------------------------------------
        # AGREGAR GLOBAL NORMALMENTE
        # ----------------------------------------------------
