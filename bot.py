...
class MiBot(commands.Bot):
    ...
    async def load_persistent_views(self):
        ...
        try:
            ...
            print(
                "✅ View persistente: TicketView"
            )

            print(
                "✅ View persistente: CloseTicketView"
            )
    ...
    async def sync_commands(self):
        ...
        try:
            ...
            roles_command = discord.utils.get(
                synced,
                name="roles"
            )
            ...
            ticket_command = discord.utils.get(
                synced,
                name="ticket"
            )
            ...
            if ticket_command:
                ...
                print(
                    "🎫 ⚠️ /ticket NO apareció."
                )


            # ------------------------------------------------
            # COMPROBAR MEDIA ROLE
            # ------------------------------------------------

            media_command = discord.utils.get(
                synced,
