...
# ID DEL SERVIDOR PRINCIPAL
GUILD_ID = 1534290216418938891
# Servidor opcional de prueba
...
class MiBot(commands.Bot):
    def __init__(self):
        ...
        self.cogs_loaded = []
        self.cogs_failed = []
        # Indica si tuvimos que crear el /ticket de respaldo
        self.ticket_fallback = False
    # ========================================================
    # SETUP HOOK
    # ========================================================
    ...
    async def ensure_ticket_command(self):
        ...
        try:
            ...
            print(
                "❌ No se pudo importar TicketView."
            )
            print(
            ...
            return
        # ----------------------------------------------------
        # CREAR COMANDO DE RESPALDO
        # ----------------------------------------------------
        @self.tree.command(
            name="ticket",
            description="Abrir el panel de tickets."
        )
        async def ticket_fallback(
            interaction: discord.Interaction
        ):
            print("")
            print("=" * 70)
            print("🎫 /TICKET RECIBIDO")
            print("=" * 70)
            try:
                view = TicketView()
                await interaction.response.send_message(
                    "🎫 **Sistema de Tickets**\n\n"
                    "Seleccioná una opción para abrir un ticket.",
                    view=view
                )
                print(
                ...
                try:
                    if interaction.response.is_done():
                        await interaction.followup.send(
                            "❌ No se pudo cargar el sistema de tickets.",
                            ephemeral=True
                        )
                    else:
                        await interaction.response.send_message(
                    ...
                    pass
        self.ticket_fallback = True
        print(
            "✅ Se creó /ticket de respaldo."
        )
    # ========================================================
    # VIEWS PERSISTENTES
    # ========================================================
    ...
    async def sync_commands(self):
        ...
        try:
            ...
            # Copiamos los comandos actuales
            ...
            if ticket:
                print(
                    "🎫 ✅ /ticket está sincronizado."
                )
            else:
                print(
                    "🎫 ⚠️ /ticket NO apareció en la sincronización."
                )
        except Exception as error:
            print("")
            print(
