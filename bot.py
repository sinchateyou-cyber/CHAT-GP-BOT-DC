...
# ============================================================
def get_security_cog(guild_id, cog_name):
    if not bot.is_ready():
        return None, "El bot todavía no está listo."
    guild = bot.get_guild(int(guild_id))
    if guild is None:
        return None, "El bot no está en este servidor."
    cog = bot.get_cog(cog_name)
    if cog is None:
        return None, f"El sistema {cog_name} no está cargado."
    return cog, None
# ============================================================
# PÁGINA PRINCIPAL
# ============================================================
...
def api_security(guild_id):
    ...
    antiflood_cog = bot.get_cog("AntiFlood")
    antilink_cog = bot.get_cog("AntiLink")
    return jsonify({
        "success": True,
        "security": {
            "antispam": bool(antispam_cog),
            "antiflood": bool(antiflood_cog),
            "antilink": bool(antilink_cog)
        }
    })
# ============================================================
# CAMBIAR SEGURIDAD
# ============================================================
def change_security(guild_id, security_type):
    if not is_logged_in():
        return jsonify({
            "success": False,
            "message":
    ...
    cog_name = cog_names.get(security_type)
    if not cog_name:
        return jsonify({
            "success": False,
            "message":
...
def api_security_antispam(guild_id):
...
def api_security_antiflood(guild_id):
    return change_security(
        guild_id,
        "antiflood"
    )
...
async def on_connect():
    print("")
    print("=" * 60)
    print("🟡 BOT CONECTADO AL DISCORD GATEWAY")
    print("=" * 60)
# ============================================================
# EVENTO READY
# ============================================================
...
async def main():
    ...
    print("")
    print("=" * 60)
    print("🔵 PASO 1: EJECUTANDO bot.start()")
    print("=" * 60)
    try:
        ...
        print("❌ Revisá DISCORD_TOKEN en Render.")
        print("=" * 60)
    except discord.PrivilegedIntentsRequired as error:
        print("")
        print("=" * 60)
        print("❌ ERROR DE PRIVILEGED INTENTS")
        print(
        ...
        print("")
        print("=" * 60)
        print("❌ DISCORD CERRÓ LA CONEXIÓN")
        print(
            f"Detalles: "
            f"{error}"
        )
        ...
        print("")
        print("=" * 60)
        print("🛑 CONEXIÓN DEL BOT FINALIZADA")
        print("=" * 60)
# ============================================================
# EJECUTAR
# ============================================================
if __name__ == "__main__":
    try:
        ...
        print("")
        print("=" * 60)
        print("❌ ERROR FATAL FUERA DE MAIN")
        print(
            f"Tipo: "
            f"{type(error).__name__}"
        )
