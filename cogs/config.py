...
def set_owner_footer(
    ...
    """
    Agrega automáticamente el Owner al footer del embed.
    Si se proporciona guild_id, también muestra el ID del servidor.
    """
    if guild_id:
        embed.set_footer(
            text=(
...
class Config(
    ...
    async def config_bienvenida(
        ...
        embed = discord.Embed(
            ...
            description=(
                f"Las bienvenidas se enviarán "
                f"ahora en {canal.mention}."
            ),
    ...
    @config_group.command(
        ...
        description=(
            "Desactiva el sistema de bienvenida."
        )
    )
    @app_commands.guild_only()
    @app_commands.default_permissions(
