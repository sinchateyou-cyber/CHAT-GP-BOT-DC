...
class XP(commands.Cog):
    ...
    async def give_level_reward(
        ...
        try:
            ...
            print(
                ...
                "Revisá la jerarquía de roles."
            )
            return None
        except discord.HTTPException as error:
            print(
                f"❌ Error asignando rol: "
                f"{error}"
            )
            return None
    # ========================================================
    ...
    @app_commands.command(
        name="level",
        description=(
            "Muestra el nivel y XP "
            "de un usuario."
        )
    )
    @app_commands.describe(
        usuario=(
            "Usuario del que querés "
            "ver el nivel."
        )
    )
    async def level(
...
async def setup(bot):
    ...
    print(
        "✅ Sistema de XP cargado correctamente"
    )