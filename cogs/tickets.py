    ...
    async def abrir_ticket(
        ...
        try:
            ...
            await interaction.response.send_message(
                ...
                "Revisá que tenga **Gestionar canales** y "
                "**Gestionar roles**.",
                ephemeral=True
            )
            return
            ...
            await interaction.response.send_message(
                f"❌ Discord rechazó la creación del canal.\n"
                f"`{error}`",
                ephemeral=True
            )
            return
        ...
        embed.add_field(
            name="🛠️ Staff",
            value=staff_role.mention if staff_role else "Staff",
            inline=True
        )
        embed.set_footer(
        ...
        try:
            ...
            await channel.delete(
                reason="No se pudo enviar el mensaje inicial del ticket"
            )
            await interaction.response.send_message(
                "❌ El canal se creó, pero no pude enviar el mensaje del ticket.",
                ephemeral=True
            )
            return
        # ====================================================
