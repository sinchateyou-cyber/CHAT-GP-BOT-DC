...
async def procesar_rol(
    ...
    try:
        ...
        await interaction.response.send_message(
            ...
            "Asegurate de que el rol del bot esté por encima "
...
class RoleSelect(discord.ui.Select):
    ...
    def __init__(
        ...
        for emoji, role_id in opciones.items():
            ...
            # Si el rol no existe, no lo mostramos
            if role is None:
                continue
...
class ReactionRoles(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        print(
            "[REACTION ROLES] Cargando sistema..."
        )

        self.registrar_views()

    # ========================================================
    # REGISTRAR VIEWS AL ARRANCAR
    # ========================================================
